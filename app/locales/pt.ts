export default {
  ...
  settings: {
    ...
    cloudAccount: {
      ...
      signOutConfirmMessage: 'Ao sair, você pode continuar usando como convidado. Seus dados neste dispositivo serão mantidos.\n\nImportante: Se entrar com outra conta, os dados locais serão apagados e substituídos pelos dados da nova conta.',
      signOutConfirm: 'Sair',
  ...
  auth: {
    ...
    signUpSuccessMessage: 'Sua conta foi criada com sucesso. Agora você pode entrar com seu e-mail e senha.',
